...
function getArticleHint(article, nextWord) {
  ...
  const usage = isDefinite
    ? 'Предмет <b>уже известен</b> обоим собеседникам, является единственным в своём роде, или обозначает общее понятие / категорию. По-русски — «тот самый», «этот» — или вообще не переводится.'
    : 'Предмет <b>упоминается впервые</b>, неизвестен собеседнику или является «одним из многих». По-русски — «какой-то», «один», «некий» — или не переводится.';
